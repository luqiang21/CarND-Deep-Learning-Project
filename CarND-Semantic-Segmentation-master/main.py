...
def load_vgg(sess, vgg_path):
    ...
    w1 = graph.get_tensor_by_name(vgg_input_tensor_name) # input image layer
...
def train_nn(sess, epochs, batch_size, get_batches_fn, train_op, cross_entropy_loss, input_image,
    ...
    for epoch in range(epochs):
        ...
        for batch, (image, label) in enumerate(get_batches_fn(batch_size)):
            ...
            print('Epoch:', epoch+1, 'batch:', batch+1, 'loss:', loss)
            losses.append(loss)
...
def run():
    ...
    data_dir = '/Users/LuQiang/Downloads/carnd-segmentation/'#'./data'
    runs_dir = '/Users/LuQiang/Downloads/carnd-segmentation/runs'#'./runs'
